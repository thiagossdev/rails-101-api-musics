...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { author: @music.author, description: @music.description, genre: @music.genre, name: @music.name } }, as: :json
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { author: @music.author, description: @music.description, genre: @music.genre, name: @music.name } }, as: :json
    assert_response 200
  end
